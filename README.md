...
1.  Datasets used and their sources
    We used a Kaggle dataset containing information on Seattle Bike Sharing. This data included the different bike stations, weather, and, trips taken on the bikes.
